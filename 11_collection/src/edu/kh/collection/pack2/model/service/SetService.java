...
//		Set<String> set = new LinkedHashSet<String>(); [ 순서 o ]
//		Set<String> set = new TreeSet<String>(); [ 정렬 o ]
		// 다형성 중 업캐스팅 적용
		...
		set.add(null);
		set.add(null);
		System.out.println(set); // null 1회 출력 확인
		...
		System.out.println( set.remove("배달의민") );
		System.out.println(set);
		
		// 4. boolean contains(E e) :
		// 전달받은 e가 set에 잇으면 true, 없으면false 반환
	...
	public void method3() {
		...
		// A.equals(B) : A와 B가 가지고있는 필드값이 같다면 true반환
	 ...
	 * 금액 입력 : 3000
	 * 
	 * 1회 : [11, 29, 34, 42, 43, 44]
	 * 2회 : [12, 29, 34, 42, 43, 44]	
	 * 3회 : [13, 29, 34, 42, 43, 44]
	 */
	public void lottoNumberGenerator() {
		...
		// 생성된 로또 번호 묶음(treeset)을 저장할 리스트
